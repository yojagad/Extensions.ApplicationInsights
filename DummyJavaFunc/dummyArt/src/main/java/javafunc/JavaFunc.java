...
public class JavaFunc {
    ...
    public HttpResponseMessage run(
			...
			@CustomBinding(direction = "inout", name = "appInsights", type = "ApplicationInsightsContext") ApplicationInsightsTag tag,
        ...
        return request.createResponseBuilder(HttpStatus.OK).body("I got Id:").build();
